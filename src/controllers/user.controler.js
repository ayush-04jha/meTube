...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // const coverImageLocalPath = req.files?.coverImage[0]?.path; // agr isko core if lese se agay check nhi kr rhe toh yeh undefine error throw kr skta hai...
  //so do following
...
//   console.log(req.files.coverImage[0]);
  ...
  ); // .select bata rha ki kya kya hame nhi chahiye... iss case me password and refreshToken
  if (!createdUser) {
